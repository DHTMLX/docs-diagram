...
const SITE_NAME = 'DHTMLX Diagram Docs';
const PRODUCT_NAME = 'DHTMLX Diagram';
const PRODUCT_URL = 'https://dhtmlx.com/docs/products/dhtmlxDiagram/';

function resolveType(pathname) {
    const path = (pathname || '').replace(/\/+$/, '');
    if (path === '' || path === '/diagram') return 'SoftwareApplication';
