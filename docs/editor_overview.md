...
You may customize the [shapebar](guides/diagram_editor/shapebar.md) and, if you have added a custom shape, [configure the editbar](api/diagram_editor/editbar/config/properties_property.md) according to the attributes of your shape.
...
That's all. Now you can start working with diagrams or keep exploring the inner world of JavaScript Diagram and Diagram Editor in the [guides](guides/overview.md).
