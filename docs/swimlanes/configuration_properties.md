...
- [Diagram. Default mode. Game levels and locations](https://snippet.dhtmlx.com/1h4j9gb3?text=#diagram&mode=wide)
- [Diagram. Default mode. Swimlane template](https://snippet.dhtmlx.com/z6x5m3gb?text=#diagram&mode=wide)
- [Diagram. Default mode. Waterfall diagram template](https://snippet.dhtmlx.com/k5vlvj8i?text=#diagram&mode=wide)
- [Diagram. Default mode. Eisenhower matrix example](https://snippet.dhtmlx.com/yfvccvc4?mode=wide)<br>Read the details in the [How to Build a JavaScript Eisenhower Matrix with DHTMLX](https://snippet.dhtmlx.com/yfvccvc4?mode=wide) article