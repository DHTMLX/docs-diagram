...
To load a data set into the editor, use the [parse()](api/diagram_editor/editor/methods/parse_method.md) method of the editor.
...
When you use a diagram together with an editor, you can import data from the diagram into the editor via the [import()](api/diagram_editor/editor/methods/import_method.md) method of the editor object:
