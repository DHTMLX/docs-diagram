...
{{note
The most recommended option is to enable the default set of controls by specifying the *true* value in the `shapeToolbar` array and create your own control(s) by adding an icon object to the array.}}
