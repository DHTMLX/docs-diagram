...
:::note
After defining the default settings for the shapes/lines of separate types, you can either omit these properties or redefine their values while [preparing a data set](guides/loading_data.md#preparing-data-to-load) for the shapes/lines of these types.
:::
