...
- `type` - имя элемента Diagram или группы элементов
    ...
    - `function` - функция обратного вызова, которая должна возвращать массив объектов с конфигурацией элементов управления элемента Diagram. Функция вызывается с объектом, включающим следующие параметры:
