...
Передайте id линии, заголовки которой нужно перебрать, в качестве первого параметра. В приведённом выше примере функция обратного вызова будет применена к каждому дочернему элементу указанной линии и вернёт их id.
