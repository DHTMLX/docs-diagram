...
Чтобы задать нужную тему, будь то [встроенная тема Diagram](guides/themes.md) или [пользовательская](guides/themes/custom_theme.md), используйте один из способов, описанных ниже:
