...
title: Editor API 概览
description: 您可以在 DHTMLX JavaScript Diagram 库的文档中查看 Editor API 概览。浏览开发者指南和 API 参考，试用代码示例和在线演示，并下载 DHTMLX Diagram 的免费 30 天评估版。
---

# Editor API 概览 {#editor-api-overview}

## Editor 方法 {#editor-methods}
